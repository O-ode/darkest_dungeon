...
class HeroComposite(CharacterComposite):
    ...
    def __init__(self, factory: Type[HeroFactoryType]):
        super(HeroComposite, self).__init__(factory)
        self._combat_move_skill: MoveSkill or None = None
        self._deaths_door_effects: DeathsDoor or None = None
    ...
    def set_deaths_door_effects(self, value: Any):
        self._deaths_door_effects = self._factory.prepare_deaths_door_effects(*value)
